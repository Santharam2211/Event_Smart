                                    ...
                                    {reg.attendanceStatus && (
                                        <>
                                            <button
                                                ...
                                                className={`flex-1 sm:flex-none p-3 font-bold rounded-xl flex items-center justify-center gap-2 transition-all ${
                                                    (reg.event?.feedbackForm?.length > 0 && !reg.feedbackSubmitted)
                                                    ? 'bg-gray-100 text-gray-400 cursor-not-allowed'
                                                    : 'bg-primary-100 text-primary-700 hover:bg-primary-200'
                                                }`}
                                                title={reg.event?.feedbackForm?.length > 0 && !reg.feedbackSubmitted ? 'Complete feedback first' : 'Download Certificate'}
                                            >
                                            ...
                                            {reg.event?.feedbackForm?.length > 0 && !reg.feedbackSubmitted && (
                                                <button
                                                    ...
                                                    className="flex-1 sm:flex-none p-3 bg-emerald-600 text-white font-bold rounded-xl flex items-center justify-center gap-2 hover:bg-emerald-700 transition-all shadow-lg shadow-emerald-100"
                                                >
